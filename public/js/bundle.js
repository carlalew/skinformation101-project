        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Registered successfully! Welcome to Skinformation101!');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateMe.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"consultations.js":[function(require,module,exports) {
"use strict";
...
var bookConsultation = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, phone, skinConcern, currentRoutine) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://127.0.0.1:3000/api/v1/consultations/book-consulation',
              data: {
                name: name,
                email: email,
                phone: phone,
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Consultation booked successfully! A member of our team will be in touch within 24 hours.');
              window.setTimeout(function () {
                location.assign('/');
              }, 3000);
            }
  ...
  return function bookConsultation(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookConsultation = bookConsultation;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addNewProduct.js":[function(require,module,exports) {
"use strict";
...
var addProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(brand, name, skinType, price, summary, description, coverImage) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Product Added Successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 3000);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            _context2.t0 = _context2["catch"](0);
            console.log(_context2.t0.response);
            (0, _alerts.showAlert)('error', 'Error deleting product! Try again.');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addNewBlog.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteBlog = exports.addBlog = void 0;
...
var addBlog = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, summary, blogContent, coverImage) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Blog Added Successfully!');
              window.setTimeout(function () {
  ...
  return function addBlog(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.t0 = _context2["catch"](0);
            console.log(_context2.t0.response);
            (0, _alerts.showAlert)('error', 'Could not delete this product! Try again later!');
...
var _addNewProduct = require("./addNewProduct");

var _addNewBlog = require("./addNewBlog");
...
var consultationForm = document.querySelector('.form--consultations');
var newProductForm = document.querySelector('.new-product-form');
var deleteProductButton = document.querySelector('.btn--delete');
var newBlogForm = document.querySelector('.form--new-blog');
var deleteBlogButton = document.querySelector('.btn--delete-blog'); // Sign Up
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  console.log(form);
  (0, _updateMe.updateSettings)(form, 'data');
});
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateMe.updateSettings)({
...
if (consultationForm) consultationForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  var email = document.getElementById('email').value;
  var phone = document.getElementById('phone').value;
  var skinConcern = document.getElementById('skinConcern').value;
  var currentRoutine = document.getElementById('currentRoutine').value;
  (0, _consultations.bookConsultation)(name, email, phone, skinConcern, currentRoutine);
}); // Add a New Product

if (newProductForm) newProductForm.addEventListener('submit', function (e) {
  e.preventDefault();
